...
class CI_Pagination {
	...
	var $uri_segment		= 3;
	var $full_tag_open		= '<div class="main-pagination">';
	var $full_tag_close		= '</div>';
	var $first_tag_open		= '';
	var $first_tag_close	= '&nbsp;';
	var $last_tag_open		= '&nbsp;';
	var $last_tag_close		= '';
	var $cur_tag_open		= '<div class="selected-page">';
	...
	function create_links()
	{
		...
		for ($loop = $start -1; $loop <= $end; $loop++)
		{
			...
			if ($i >= 0)
			{
				...
				{
					$n = ($i == 0) ? '' : $i;
					$output .= $this->num_tag_open.'<a href="'.$this->base_url.$i.$this->suffix.'">'.$loop.'</a>'.$this->num_tag_close;
				}
			}
		}
