...
class Preferences extends Controller {
	...
	function index()
	{
		...
		else
		{
			...
			$this->form_validation->set_rules('random_titles','Show Random Titles', 'trim|xss_clean');
			$this->form_validation->set_rules('new_post_notification','New Post Notification', 'trim|xss_clean');
